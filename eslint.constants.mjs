...
export const sharedRules = {
    ...
    'n/no-missing-import': [ 'off', { ignoreTypeImport: true }],
    'n/no-missing-require': [ 'off', { ignoreTypeImport: true }],
    'n/no-unsupported-features/node-builtins': [ 'warn', { version: '>=24.0.0' }],
    'new-cap': [
        'warn',
        {
...
export const vueAndNuxtRules = {
    ...
    'vue/sort-keys': 'off', // ?: Da riattivare quando ho voglia di sistemare tutti gli oggetti
    'vue/space-unary-ops': [
        'warn',
        {
            nonwords: true,
